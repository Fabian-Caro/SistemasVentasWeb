...
<html>
    <head>
        ...
        <style>
            ...
            body, .table, .card, .card-body, .form-control, .form-control:focus, .table > :not(caption) > * > * {
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="Controlador?menu=NuevaVenta" method="POST">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex" style="margin-right: 10px;">
                                    <input type="text" name="txtCodigoProducto" value="${productoBuscar.getIdProducto() != null ? productoBuscar.getIdProducto() : '0'}" class=" form-control" placeholder="Código Producto" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-4 d-flex" style="margin-right: 10px;">
                                    <input type="text" name="txtPrecioProducto" value="${productoBuscar.getPrecioProducto()}" class="form-control" placeholder="$000.00" readonly="">
                                </div>
